...
<div className="form-group">
 ...
 <div className="footer">
   <Button onClick={signup} variant="contained" color="secondary" > Sign Up</Button>
      ...
      <div className="footer">
        ...
        <Button onClick={ForgotPassword} variant="contained" color="secondary" >  Forgot Password</Button>
        </div>
        <br></br>
        </div>
        </div>
